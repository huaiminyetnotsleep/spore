      ...
      >
        ...
        {data?.configured ? (
          <Space wrap>
            ...
            <Popconfirm
              title="确定清除 GitHub Client ID 与 Secret？此操作不会影响访问密钥登录。"
              okText="确认"
              cancelText="取消"
              okButtonProps={{ danger: true }}
              onConfirm={() => void save.run({ action: "clear" })}
            >
              <Button danger loading={save.pending}>
                清除凭据
              </Button>
            </Popconfirm>
          </Space>
      ...
      <SectionCard title="绑定管理员账号">
        {data?.bound ? (
          <Space direction="vertical" size="small">
            ...
            <Popconfirm
              title="确定解绑 GitHub 账号？全部会话将立即失效。"
              okText="确认"
              cancelText="取消"
              okButtonProps={{ danger: true }}
              onConfirm={() => void unbind.run(undefined)}
            >
              <Button loading={unbind.pending}>解绑 GitHub 账号</Button>
            </Popconfirm>
          </Space>
        ) : (
          <Space direction="vertical" size="small">
