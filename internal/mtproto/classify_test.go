...
func TestClassifyTgError(t *testing.T) {
	cases := []struct {
		...
		{"账号级限制", tgerr.New(400, "PEER_FLOOD"), apperr.CodePeerFlood},
		{"媒体非法", tgerr.New(400, "MEDIA_INVALID"), apperr.CodeMediaUnsupported},
		{"媒体为空", tgerr.New(400, "MEDIA_EMPTY"), apperr.CodeMediaUnsupported},
