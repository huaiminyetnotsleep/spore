...
func TestRegisterCommandsDefaultList(t *testing.T) {
	var calls atomic.Int32
	b := commandTestBot(t, func(w http.ResponseWriter, r *http.Request) {
		calls.Add(1)
		...
		want := []string{"start", "help", "status", "health", "usage", "cancel", "download", "pin", "bind", "unbind", "channels", "join", "watch", "watchlist", "unwatch"}
		var got []string
